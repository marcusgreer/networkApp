...
module.exports = function (app, io) {
	...
	// Routing the HTTP get requests to the "views/index.html" file
	app.get("/", function(req,res) {
		res.sendFile(path.resolve(__dirname+"/../views/index.html"));
	});

	// Routing the HTTP post requests to the 
	app.post('/register', function(req, res) {
        ...
        // query the user database to get toe user that matches the handle
